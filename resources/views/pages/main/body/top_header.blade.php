<header class="header">
            <div class="page-brand">
                <a class="link" href="index.html">
                    <span class="brand">Coder
                        <span class="brand-tip">Rocket</span>
                    </span>
                    <span class="brand-mini">CR</span>
                </a>
            </div>
                ...
                <ul class="nav navbar-toolbar">
                            ...
                            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 240px;"><li class="list-group list-group-divider scroller" data-height="240px" data-color="#71808f" style="overflow: hidden; width: auto; height: 240px;">
                                <div>
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ env('APP_URL_LINK')}}/lib/admin_cast/dist/assets/img/users/u1.jpg">
                                            </div>
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ env('APP_URL_LINK')}}/lib/admin_cast/dist/assets/img/users/u2.jpg">
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ env('APP_URL_LINK')}}/lib/admin_cast/dist/assets/img/users/u3.jpg">
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ env('APP_URL_LINK')}}/lib/admin_cast/dist/assets/img/users/u4.jpg">
                                            </div>
                                            <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            <img src="{{ env('APP_URL_LINK')}}/lib/admin_cast/dist/assets/img/admin-avatar.png">
